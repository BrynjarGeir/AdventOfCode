...
rounds = 10000
div_value = reduce(lambda x,y: x * y, monkeys_test.values())
    ...
    for monkey in monkeys_items:
        ...
        while monkeys_items[monkey]:
            ...
            if not value % monkeys_test[monkey]:
                monkeys_items[monkeys_throw[monkey][0]].append(value % div_value)
            else:
                monkeys_items[monkeys_throw[monkey][1]].append(value % div_value)
