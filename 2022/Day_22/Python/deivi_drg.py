...
class JungleCube:
    ...
    def wrap_location(
        ...
        if self.direction_index == 0 and angle == 0:
            return (0, y)
        elif self.direction_index == 0 and angle == 1:
            return (y, N)
        elif self.direction_index == 0 and angle == 2:
            return (N, N - y)
        elif self.direction_index == 0 and angle == 3:
            return (N - y, 0)
        elif self.direction_index == 1 and angle == 0:
            return (x, 0)
        elif self.direction_index == 1 and angle == 1:
            return (0, N - x)
        elif self.direction_index == 1 and angle == 2:
            return (N - x, N)
        elif self.direction_index == 1 and angle == 3:
            return (N, x)
        elif self.direction_index == 2 and angle == 0:
            return (N, y)
        elif self.direction_index == 2 and angle == 1:
            return (y, 0)
        elif self.direction_index == 2 and angle == 2:
            return (0, N - y)
        elif self.direction_index == 2 and angle == 3:
            return (N - y, N)
        elif self.direction_index == 3 and angle == 0:
            return (x, N)
        elif self.direction_index == 3 and angle == 1:
            return (N, N - x)
        elif self.direction_index == 3 and angle == 2:
            return (N - x, 0)
        elif self.direction_index == 3 and angle == 3:
            return (0, x)
        else:
...
if __name__ == "__main__":
    ...
    print(f"The final position is {jungle.in_map_location()} and the final direction is {jungle.direction_index}.")